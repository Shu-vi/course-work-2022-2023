...
const MyTableTwoField: FC<Props> = ({users}) => {
    ...
    const differenceSchool1 = difference(user1.schools, intersectionSchools, schoolCompareFunc);
    const differenceSchool2 = difference(user2.schools, intersectionSchools, schoolCompareFunc);
